    ...
    customModule.controller('SimpleCtrl', ['$scope', 'propertyService',
        function ($scope, propertyService) {
            ...
            $scope.feedback.savingHandlers.push(function () {
                $scope.properties.Description.PropertyValue = tinyMCE.get('txtDescription').getContent();
            ...
            propertyService.get()
                .then(function (data) {
                    if (data) {
                        ...
                        tinyMCE.get('txtDescription').setContent($scope.properties.Description.PropertyValue);
