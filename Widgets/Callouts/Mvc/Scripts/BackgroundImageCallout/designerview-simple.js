    ...
    customModule.controller('SimpleCtrl', ['$scope', 'propertyService',
        function ($scope, propertyService) {
            ...
            $scope.feedback.savingHandlers.push(function () {
                $scope.properties.MainContent.PropertyValue = tinyMCE.get('txtMainContent').getContent();
            ...
            propertyService.get()
                .then(function (data) {
                    if (data) {
                        ...
                        tinyMCE.get('txtMainContent').setContent($scope.properties.MainContent.PropertyValue);
