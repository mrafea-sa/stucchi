...
{
    public class CircleImageCalloutModel : _BaseModel
    {
        /// <inheritdoc />
        ...
        {
            var viewModel = new CircleImageCalloutViewModel()
            {
                Title = this.Title,
        ...
        private ArrayList GetProcessedItemsSelectedItems(dynamic items)
        {
            ...
            foreach (dynamic item in items)
            {
                ...
                DynamicContent itemContent = DynamicContentOps.GetGenericItemById(ModuleTypes.CalloutsCircleImageName, itemId);
